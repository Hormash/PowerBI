<#
   Puropse:
    Puropse of this script is to get all refresh times for all workspaces in dedicated capacity. As we know, at the momnet, there is no easy tool
    to present at what time, what dataset is refreshing.
    With this script we can get a list of workspace,dataset and time when its set to refresh.
   ...
   - You need to be admin to every workspace that you want to analyze, if you are not script will fail
   - Adding yourself as administrator is easy :) - just search net!
